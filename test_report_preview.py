...
def main():
    ...
    print("\n--- Would post to Slack ---")
    print(f"Customer emails received: {stats.received_count}")
    print(f"Staff replies sent:       {stats.reply_count}")
    print(f"New conversations:        {stats.new_conversations}")
    print(f"Conversations touched:    {stats.conversations_touched}")
    ...
    print(f"Notifications filtered:   {stats.notification_count}")
